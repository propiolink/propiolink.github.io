...
ctl()}
  ...
  function usar(){
  if(localStorage.us!=""){copyTo();openPage(`https://quintadb.com/apps/ddPsyqytvcROk-fKOxW5vX/dtypes/${localStorage.us}/edit?entity_id=cmWPT4mSjaxik9amkih8oz?&overal_dtypes_size=1&widget=true`)}
  }
function copyTo(){ 
